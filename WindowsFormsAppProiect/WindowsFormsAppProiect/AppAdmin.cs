...
namespace WindowsFormsAppProiect
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            InsertFacultyAdmin ifa = new InsertFacultyAdmin();
            ifa.Show();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            UpdateFacultyAdmin ufa = new UpdateFacultyAdmin();
            ufa.getFaculty(faculty);
            ufa.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string faculty = comboBox1.Text;
            if (faculty.Length > 1 && faculty !="Faculty")
            {
                Delete del = new Delete();
                del.getFaculty(faculty);
                del.Show();
            }
            else MessageBox.Show("Please select a faculty!");
            
        }

        private void insertCourse_Click(object sender, EventArgs e)
        {
            InsertCourseAdmin ica = new InsertCourseAdmin();
            ica.Show();
        }
        ...
        private void updateCourse_Click(object sender, EventArgs e)
        {
            ...
            int semester = Convert.ToInt32(comboBox3.Text);
            UpdateCourseAdmin ica = new UpdateCourseAdmin();
            ica.getData(course,faculty,year,semester);
            ica.Show();
        }
        ...
        {
            string course = comboBox4.Text;
            if (course.Length > 1 && course != "Course")
            {
                Delete del = new Delete();
                del.getCourse(course);
                del.Show();
            }
